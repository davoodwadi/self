...
export default function DigitalTransformationWeek1() {
  return (
    <main className="theme-crimson-noir relative w-full overflow-x-hidden bg-background min-h-screen font-body text-text-primary">
      ...
      <ZigzagContent
        ...
        segments={[
          ...
          },
          {
            ...
            label: "KEY INSIGHT",
            content:
              "Digital transformation goes beyond digitization by rethinking business models and processes, focusing on enhancing customer experiences and creating new value propositions.",
          },
          {
            type: "text",
            content: (
      ...
      <DataBlock
        label="FRAMEWORK"
        title="The 6 Layers of Transformation"
        altBg={true}
      >
        <div className="flex justify-center mb-12">
          <Image
            src={dtPyramidImg}
            alt="Digital Transformation Pyramid"
            className="max-w-full h-auto rounded-xl object-contain max-h-[60vh]"
          />
        </div>
      </DataBlock>

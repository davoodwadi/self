            ...
            <div className="tl-slide-inner">
                <div className="tl-two-col">
                    <div>
                        ...
                        <p className="p-body tl-message">{"Discount evaluation requires deeper search because the model must acquire and integrate list price, discount percentage, and weight."}</p>
                    </div>
                    <div>

...
import { Bullets, SlideShell } from "./SlidePrimitives";
...
export default function ResourceRationalitySlide() {
  ...
  return (
    <SlideShell
      number="06"
      eyebrow="Resource Rationality"
      title={
        <>
          Bias can be a <span className="grad-violet-cyan">cost-saving policy</span>
        </>
      }
      message="Resource rationality says agents should maximize expected utility net of computation, information, time, and monetary costs."
    >

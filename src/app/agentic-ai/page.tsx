  ...
  return (
    ...
    <SlideDeck >
      ...
      <Slide>
        ...
        <Grid gap="large" className="mt-12">
      ...
      <Slide>
        <Tag>Definitions</Tag>
        <Heading>Defining <Highlight>Agentic AI</Highlight></Heading>
        <Grid gap="large" items="center">
          <Column spanRatio="1/2">
            ...
            <AnimatedList>
              <ListItem>From 2024 "AI Copilots" to 2026 "Autonomous Agents".</ListItem>
              <ListItem>Agents now negotiate, research, and execute tasks outside the IDE.</ListItem>
            </AnimatedList>
          </Column>
          <Column spanRatio="1/2">
      ...
      <Slide>
        ...
        <Heading>The <Highlight>Microservices</Highlight> Moment</Heading>
        <Subtitle variant="section">Multi-agent orchestration over monolithic LLMs</Subtitle>
        <Grid gap="large">
          <Column spanRatio="1/2">
            <Card>
      ...
      <Slide>
        ...
        <Grid gap="large">
          <Column spanRatio="1/2">
            <AnimatedList>
              <ListItem>Security and governance cannot be an afterthought.</ListItem>
              <ListItem>Strict permission boundaries and decision logs are central.</ListItem>
              <ListItem>Human-in-the-loop approval prevents rogue actions.</ListItem>
            </AnimatedList>
          </Column>
          <Column spanRatio="1/2">
      ...
      <Slide>
        <Tag>Culture</Tag>
        <Heading>The <Highlight>Vibe Coding</Highlight> Phenomenon</Heading>
        <Grid gap="large" items="center">
          <Column spanRatio="1/2">
            <Card>
      ...
      <Slide>
        ...
        <Subtitle variant="section">Prioritizing momentum over structural planning</Subtitle>
        <Grid gap="large">
          <Column spanRatio="1/2">
            <ContentText layout="base">
      ...
      <Slide>
        ...
        <Grid gap="large" items="center">
          <Column spanRatio="1/2">
            <AnimatedList>
              <ListItem>Non-technical workers (marketing, legal, sales) building functional digital products.</ListItem>
              <ListItem>Amateurs spinning up MVPs over a weekend without knowing a programming language.</ListItem>
              <ListItem>Shift of power from IT to the rest of the organization.</ListItem>
            </AnimatedList>
          </Column>
          <Column spanRatio="1/2">
      ...
      <Slide>
        <Tag>Comparison</Tag>
        <Heading>Vibes vs. <Highlight>Engineering</Highlight></Heading>
      ...
      <Slide>
        <Tag>Risks</Tag>
        <Heading>Accelerated <Highlight>Technical Debt</Highlight></Heading>
        <Subtitle variant="section">Writing bad code faster</Subtitle>
        <Grid gap="large">
          <Column spanRatio="1/2">
            <AnimatedList>
              <ListItem>AI tools can write flawed or poorly integrated code at lightning speed.</ListItem>
              <ListItem>Applications built purely on vibes become incredibly brittle over time.</ListItem>
              <ListItem>Massive accumulations of technical debt must eventually be reconciled.</ListItem>
            </AnimatedList>
          </Column>
          <Column spanRatio="1/2">
      ...
      <Slide>
        ...
        <Subtitle variant="section">Blindly accepting AI-generated code</Subtitle>
        <Grid gap="large">
          <Column spanRatio="1/2">
            <ContentText layout="base">
      ...
      <Slide>
        ...
        <Grid gap="large" items="center">
          <Column spanRatio="1/2">
            <AnimatedList>
              <ListItem>Writing reliable software requires specifying edge cases, designing UX, and planning for scale.</ListItem>
              <ListItem>Natural language prompts are often "wish lists" rather than engineering blueprints.</ListItem>
              <ListItem>Apps work flawlessly in ideal conditions but break under real-world strain.</ListItem>
            </AnimatedList>
          </Column>
          <Column spanRatio="1/2">
      ...
      <Slide>
        <Tag>Evolution</Tag>
        <Heading>Instruction vs. <Highlight>Orchestration</Highlight></Heading>
        <Subtitle variant="section">A historical shift in human-computer interaction</Subtitle>
        <Grid gap="large">
          <Column spanRatio="1/2">
            <Card>

---
topic: Pricing Strategies (The Second P)
...
- It often involves introducing less expensive versions of established brand-name products.
- Value-added pricing attaches value-added features to differentiate offers.
- This allows companies to charge higher prices rather than cutting prices to match competitors.
...
- If the offer provides greater value, a higher price can be justified.

## Discussion: Pricing Approaches
...
- Product line pricing determines the price steps between various products in a line.
- It is based on cost differences, customer evaluations of features, and competitors' prices.
...
## Discussion: Product Mix Pricing
...
- Discussion: Should they price the machine low to sell more pods or price the machine high to maintain a premium brand image?

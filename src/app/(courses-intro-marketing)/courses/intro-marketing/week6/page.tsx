    ...
    <SlideDeck background={<BackgroundManager type="marketing" />}>
      ...
      <Slide>
        ...
        <AnimatedList className="mt-12 text-center max-w-2xl mx-auto">
          ...
          <ListItem>
            We will cover the bases for segmenting markets, evaluating and
            selecting target markets, and developing a compelling positioning
            strategy.
          </ListItem>
        </AnimatedList>
        <Figure height="sm">
      ...
      <Slide>
        ...
        <AnimatedList>
          <ListItem>
            <Highlight>Market segmentation</Highlight> involves dividing a
            market into distinct groups of buyers who have different needs,
            characteristics, or behaviors.
          </ListItem>
          <ListItem>
            These distinct groups might require separate products or marketing
            programs.
          </ListItem>
          <ListItem>
            The goal is to identify segments that are measurable, accessible,
      ...
      <Slide
        quizData={quizBySlideId["geographic-and-demographic-segmentation"]}
      >
        <Heading>Geographic and Demographic Segmentation</Heading>
        <AnimatedList>
          <ListItem>
            <Highlight>Geographic segmentation</Highlight> divides the market
            into different geographical units, such as nations, states, regions,
            counties, cities, or even neighborhoods.
          </ListItem>
          <ListItem>
            <Highlight>Demographic segmentation</Highlight> divides the market
            into segments based on variables such as age, life-cycle stage,
            gender, income, occupation, education, religion, ethnicity, and
            generation.
          </ListItem>
          <ListItem>
            Demographic variables are the most popular bases for segmenting
            customer groups because they are easier to measure.
          </ListItem>
        </AnimatedList>
      </Slide>
      ...
      <Slide>
        ...
        <AnimatedList>
          <ListItem>
            <Highlight>Psychographic segmentation</Highlight> divides buyers
            into different segments based on lifestyle or personality
            characteristics.
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            ...
            offering products that align with consumer lifestyles.
          </ListItem>
        </AnimatedList>
      </Slide>
      ...
      <Slide quizData={quizBySlideId["behavioral-segmentation"]}>
        ...
        <AnimatedList>
          <ListItem>
            <Highlight>Behavioral segmentation</Highlight> divides buyers into
            segments based on their knowledge, attitudes, uses, or responses to
            a product.
          </ListItem>
          <ListItem>
            Variables include occasions, benefits sought, user status, usage
            rate, and loyalty status.
          </ListItem>
          <ListItem>
            Benefit segmentation requires finding the major benefits people look
            for in a product class, the kinds of people who look for each
      ...
      <Slide>
        ...
        <AnimatedList>
          ...
          <ListItem>
            Business buyers can be segmented geographically, demographically, or
            by benefits sought, user status, usage rate, and loyalty status.
          </ListItem>
          <ListItem>
            However, business marketers also use additional variables, such as
      ...
      <Slide>
        ...
        <DiscussionCard title="Group Discussion">
          Think of a brand of athletic shoes. How might they use a combination
          of demographic, psychographic, and behavioral segmentation to target a
      ...
      <Slide>
        ...
        <AnimatedList>
          <ListItem>
            <Highlight>Market targeting</Highlight> involves evaluating each
          ...
          <ListItem>
            The target market consists of a set of buyers who share common needs
      ...
      <Slide quizData={quizBySlideId["evaluating-market-segments"]}>
        ...
        <AnimatedList>
          ...
          <ListItem>
            ...
            aggressive competitors or if it is easy for new entrants to come
            into the segment.
          </ListItem>
          <ListItem>
            The company must also consider whether it has the skills and
            resources needed to succeed in that segment.
          </ListItem>
        </AnimatedList>
      </Slide>
        ...
        <Row gap="large">
          <Column spanRatio="1/2">
            ...
            <Card title="Differentiated (Segmented)" className="mt-4">
              <ContentDescription>
                Targets several market segments and designs separate offers for
                each.
              </ContentDescription>
            </Card>
          </Column>
          <Column spanRatio="1/2">
            <Card title="Concentrated (Niche)">
              <ContentDescription>
                Focuses on acquiring a large share of one or a few smaller
                segments or niches.
              </ContentDescription>
            </Card>
            <Card title="Micromarketing" className="mt-4">
              <ContentDescription>
                ...
                specific individuals and local segments.
              </ContentDescription>
            </Card>
          </Column>
        </Row>
      ...
      <Slide>
        ...
        <DiscussionCard title="Class Discussion">
          A startup creates a new line of premium, organic, plant-based protein
          powder. Should they use differentiated marketing or concentrated
          marketing? Why?
        </DiscussionCard>
      </Slide>
      ...
      <Slide>
        ...
        <AnimatedList>
          ...
          <ListItem>
            <Highlight>Differentiation</Highlight> involves actually
            differentiating the firm&apos;s market offering to create superior
            customer value.
          </ListItem>
          <ListItem>
            <Highlight>Positioning</Highlight> consists of arranging for a
            market offering to occupy a clear, distinctive, and desirable place
      ...
      <Slide>
        ...
        <AnimatedList>
          <ListItem>
            ...
            marketers often prepare{" "}
            <Highlight>perceptual positioning maps</Highlight>.
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            The position of each circle on the map indicates the brand&apos;s
            perceived positioning, and the size of the circle may indicate the
      ...
      <Slide
        quizData={
          quizBySlideId["choosing-a-differentiation-and-positioning-strategy"]
        }
      >
        ...
        <AnimatedList>
          ...
          <ListItem>
            ...
            must understand customer needs better than competitors do and
      ...
      <Slide quizData={quizBySlideId["developing-a-value-proposition"]}>
        ...
        <AnimatedList>
          <ListItem>
            ...
            <Highlight>value proposition</Highlight>.
          </ListItem>
          <ListItem>
            It is the full mix of benefits on which a brand is differentiated
            and positioned.
          </ListItem>
          <ListItem>
            Possible value propositions include &quot;More for More,&quot;
            &quot;More for the Same,&quot; &quot;The Same for Less,&quot;
            &quot;Less for much Less,&quot; and &quot;More for Less.&quot;
          </ListItem>
        </AnimatedList>
      </Slide>
      ...
      <Slide>
        ...
        <AnimatedList>
          <ListItem>
            ...
            deliver and communicate the desired position to its target
            consumers.
          </ListItem>
          <ListItem>
            All the company&apos;s marketing mix efforts (the 4 Ps) must support
            the positioning strategy.
          </ListItem>
          <ListItem>
            Establishing a position or changing one usually takes a long time,
            but maintaining it requires consistent performance and
            communication.
          </ListItem>
        </AnimatedList>
      </Slide>
      ...
      <Slide>
        ...
        <DiscussionCard title="Group Discussion">
          Think of a popular smartphone brand. What is its value proposition,
          and how does it differentiate itself from its main competitor in the
          minds of consumers?
        </DiscussionCard>
      </Slide>
      ...
      <Slide>
        ...
        <AnimatedList>
          <ListItem>
            The STP process is essential for creating customer value and
            building profitable relationships.
          </ListItem>
          <ListItem>
            Segmentation allows marketers to identify distinct groups with
            unique needs.
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            Positioning ensures the brand occupies a clear, distinctive place in
            the consumer&apos;s mind.
          </ListItem>
        </AnimatedList>
      </Slide>

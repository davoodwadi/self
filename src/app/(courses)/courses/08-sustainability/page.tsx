          ...
          >
            ...
            <Slide className="flex flex-col items-center justify-center text-center">
              ...
              <AnimatedList className="mt-12 text-xl space-y-6">
                <ListItem>
                  Exploring the complex relationship between AI and
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  ...
                  <Callout title="Critical Pivot Point" variant="secondary">
                    The industry faces a critical pivot point between "Red AI"
                    and "Green AI" <Citation ids={[29, 30]} />.
                  </Callout>
                </Column>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  ...
                  <AnimatedList className="mt-8">
                    ...
                    <ListItem>
                      Training a model like GPT-3 emitted over 550 metric tons
                      of CO2e <Citation ids={[2, 3]} />.
                    </ListItem>
                    <ListItem>
                ...
                <Column spanRatio="1/3">
                  <DiscussionCard title="Group Discussion">
                    Why is transparency regarding training data becoming a
                    rarity?
                  </DiscussionCard>
                </Column>
              </Row>
            ...
            <Slide>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  ...
                  <AnimatedList className="mt-8">
                    <ListItem>
                      Inference constitutes the majority of lifecycle emissions
                      for deployed models <Citation ids={[1, 2]} />.
                    </ListItem>
                    <ListItem>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  ...
                  <AnimatedList>
                    ...
                    <ListItem>
                      Comparable to running a 60W light bulb for about 14
                      seconds.
                    </ListItem>
                  </AnimatedList>
                </Column>
                <Column spanRatio="1/3">
                  <DiscussionCard title="Group Discussion">
                    Is per-query efficiency enough to offset the explosive
                    growth in total usage?
                  </DiscussionCard>
                </Column>
              </Row>
            </Slide>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  <Row gap="small">
                    <Metric
                      value="700k L"
                      label="Freshwater (GPT-3 Training)"
                    />
                  ...
                  <AnimatedList className="mt-8">
                    ...
                    <ListItem>
                      Early estimates: GPT-3 training consumed ~700,000 liters
                      of freshwater <Citation ids={[1, 6]} />.
                    </ListItem>
                    <ListItem>
                      Global AI water demand could reach 6.6 billion cubic
                      meters by 2027 <Citation ids={[1, 6]} />.
                    </ListItem>
                  </AnimatedList>
                </Column>
                <Column spanRatio="1/3">
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  <AnimatedList>
                    ...
                    <ListItem>
                      Google reports 0.26 mL (five drops) per median query due
                      to efficiency <Citation ids={[4, 5]} />.
                    </ListItem>
                    <ListItem>
                      Efficiency gains fight against the sheer scale of
                      deployment.
                    </ListItem>
                  </AnimatedList>
                </Column>
            ...
            <Slide>
              ...
              <Row gap="large">
                ...
                <Column spanRatio="1/3">
                  <DiscussionCard title="Group Discussion">
                    Should hardware longevity be prioritized over peak
                    performance?
                  </DiscussionCard>
                </Column>
              </Row>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  ...
                  <AnimatedList>
                    ...
                    <ListItem>
                      Specialized chips contain hazardous materials and rare
                      earth elements <Citation ids={[16, 17]} />.
                    </ListItem>
                  </AnimatedList>
                </Column>
                <Column spanRatio="1/3">
                  <DiscussionCard title="Group Discussion">
                    What policy mechanisms could enforce better recycling rates
                    for AI hardware?
                  </DiscussionCard>
                </Column>
              </Row>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  <AnimatedList>
                    ...
                    <ListItem>
                      DeepMind-style optimization reduces cooling energy by up
                      to 40% <Citation ids={[18]} />.
                    </ListItem>
                    <ListItem>
                      Balancing Water Usage Effectiveness (WUE) against Power
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  ...
                  <AnimatedList className="mt-6">
                    ...
                    <ListItem>
                      Outperforms traditional Numerical Weather Prediction (NWP)
                ...
                <Column spanRatio="1/3">
                  <DiscussionCard title="Group Discussion">
                    How does faster disaster prediction translate to tangible
                    lives saved?
                  </DiscussionCard>
                </Column>
              </Row>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  <AnimatedList>
                    ...
                    <ListItem>
                      Enables rapid ensemble forecasting to predict extreme
                      weather probabilities <Citation ids={[21]} />.
                    </ListItem>
                    <ListItem>
                ...
                <Column spanRatio="1/3">
                  <DiscussionCard title="Group Discussion">
                    What new applications emerge when weather forecasting
                    becomes accessible to smaller organizations?
                  </DiscussionCard>
                </Column>
              </Row>
            </Slide>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  <AnimatedList>
                    ...
                    <ListItem>
                      Reinforcement Learning manages Hybrid Energy Storage
                      Systems (HESS) <Citation ids={[23, 24]} />.
                    </ListItem>
                  </AnimatedList>
                </Column>
                <Column spanRatio="1/3">
            ...
            <Slide>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  <AnimatedList>
                    <ListItem>
                      Maximizing yield while minimizing chemical inputs and
                      water usage.
                    </ListItem>
                    <ListItem>
                      Analysis of satellite imagery and soil sensors for
                      Variable Rate Technology <Citation ids={[26, 28]} />.
                    </ListItem>
                    <ListItem>
                      Smart irrigation systems optimize water delivery in
                      real-time <Citation ids={[27]} />.
                    </ListItem>
                  </AnimatedList>
                </Column>
                <Column spanRatio="1/3">
            ...
            <Slide>
              ...
              <Heading>
                <Highlight>Red</Highlight> AI vs. <Highlight>Green</Highlight>{" "}
                AI
              </Heading>
              <Row gap="large">
                <Column spanRatio="2/3">
                  ...
                  <AnimatedList className="mt-8">
                    ...
                    <ListItem>
                      Green AI: Treating carbon efficiency as a primary
                      evaluation metric.
                    </ListItem>
                    <ListItem>
                      Decoupling AI progress from exponential resource
                      consumption.
                    </ListItem>
                  </AnimatedList>
                </Column>
                <Column spanRatio="1/3">
                  <DiscussionCard title="Group Discussion">
                    What cultural shifts in research are needed to value
                    efficiency as much as accuracy?
                  </DiscussionCard>
                </Column>
              </Row>
            </Slide>
            ...
            <Slide>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  ...
                  <AnimatedList className="mt-8">
                    <ListItem>
                      Quantization: Reducing precision (e.g., 32-bit to 4-bit)
                      to save energy.
                    </ListItem>
                    <ListItem>
                      Pruning: Removing redundant weights to create sparse
                      models.
                    </ListItem>
                    <ListItem>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  <div className="mb-8">
                    <Metric
                      value="28%"
                      label="Global AI Energy Savings (2025)"
                    />
                  </div>
                  <AnimatedList>
                    <ListItem>
                      The "Small is Sufficient" trend: Using task-specific
                      models <Citation ids={[34]} />.
                    </ListItem>
                    <ListItem>
                      Adoption could save roughly 28% of global AI electricity
                      by 2025 <Citation ids={[34]} />.
                    </ListItem>
                    <ListItem>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  ...
                  <AnimatedList>
                    ...
                    <ListItem>
                      Spiking Neural Networks (SNNs): Neurons only consume
                      energy when active <Citation ids={[35, 36]} />.
                    </ListItem>
                    <ListItem>
                      Eliminates the energy cost of moving data between memory
                      and processors.
                    </ListItem>
                  </AnimatedList>
                </Column>
            ...
            <Slide>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  ...
                  <AnimatedList>
                    <ListItem>
                      Intel Loihi 2 and BrainChip Akida showing commercial
                      viability <Citation ids={[36, 37]} />.
                    </ListItem>
                    <ListItem>
                      Potential for 100x to 1000x efficiency gains in specific
                      tasks <Citation ids={[36, 38]} />.
                    </ListItem>
                    <ListItem>
                ...
                <Column spanRatio="1/3">
                  <DiscussionCard title="Group Discussion">
                    Will neuromorphic computing replace or augment traditional
                    GPU architectures?
                  </DiscussionCard>
                </Column>
              </Row>
              ...
              <Row gap="large" className="mt-8">
                <Column spanRatio="2/3">
                  <AnimatedList>
                    ...
                    <ListItem>
                      AI robotics sort waste streams with high speed and
                      accuracy <Citation ids={[40, 41]} />.
                    </ListItem>
                    <ListItem>
                      Digital Waste Passports track recovery of valuable
                      materials <Citation ids={[42]} />.
                    </ListItem>
                  </AnimatedList>
                </Column>
                <Column spanRatio="1/3">
                  <DiscussionCard title="Group Discussion">
                    How can AI incentivize consumers to participate more
                    effectively in recycling?
                  </DiscussionCard>
                </Column>
              </Row>
            </Slide>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  <AnimatedList>
                    ...
                    <ListItem>
                      General-Purpose AI providers must publish energy
                      consumption data <Citation ids={[50, 51]} />.
                    </ListItem>
                    <ListItem>
                ...
                <Column spanRatio="1/3">
                  <DiscussionCard title="Group Discussion">
                    Will the EU's regulations become the de facto global
                    standard for AI sustainability?
                  </DiscussionCard>
                </Column>
              </Row>
            </Slide>
            ...
            <Slide>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  <AnimatedList>
                    <ListItem>
                      Software tools like CodeCarbon and Green Algorithms
                      estimate emissions <Citation ids={[3, 56]} />.
                    </ListItem>
                    <ListItem>
                      Compute Carbon Intensity (CCI) quantifies carbon per unit
                      of work <Citation ids={[11]} />.
                    </ListItem>
                    <ListItem>
                      Tools may underestimate true usage by missing overheads
                      like cooling <Citation ids={[56]} />.
                    </ListItem>
                  </AnimatedList>
                </Column>
                <Column spanRatio="1/3">
            ...
            <Slide>
              ...
              <Row gap="large">
                ...
                <Column spanRatio="1/3">
                  <DiscussionCard title="Group Discussion">
                    How can individual developers influence organizational
                    choice of models?
                  </DiscussionCard>
                </Column>
              </Row>
            ...
            <Slide>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  <AnimatedList>
                    <ListItem>
                      Require Life Cycle Assessments (LCA) from hardware
                      vendors.
                    </ListItem>
                    <ListItem>
                    ...
                    <ListItem>
                      Align reporting with EU AI Act and ISO standards
                      immediately.
                    </ListItem>
                  </AnimatedList>
                </Column>
                <Column spanRatio="1/3">
                  <DiscussionCard title="Group Discussion">
                    What are the risks of ignoring the environmental component
                    of ESG goals?
                  </DiscussionCard>
                </Column>
              </Row>
              ...
              <Row gap="large">
                <Column spanRatio="2/3">
                  <AnimatedList>
                    ...
                    <ListItem>
                      Hardware-software co-design for neuromorphic
                      architectures.
                    </ListItem>
                    <ListItem>
                ...
                <Column spanRatio="1/3">
                  <DiscussionCard title="Group Discussion">
                    Can we innovate fast enough to outpace the environmental
                    damage of scaling?
                  </DiscussionCard>
                </Column>
              </Row>
            ...
            <Slide className="flex flex-col items-center justify-center text-center">
              ...
              <AnimatedList className="mt-8 text-xl space-y-6">
                ...
                <ListItem>
                  The shift to inference dominance demands new efficiency
                  strategies
                </ListItem>
                <ListItem>
                ...
                <ListItem>
                  Sustainable AI is not just an option, it is a license to
                  operate.
                </ListItem>
              </AnimatedList>
            </Slide>

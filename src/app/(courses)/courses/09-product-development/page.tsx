    ...
    <CitationProvider value={{ getCitation, getCitations, getCitationUrls }}>
      <SlideDeck background={<BackgroundManager type="agentic" />}>
        ...
        <Slide>
          ...
          <Subtitle>Davood Wadi, PhD</Subtitle>
        </Slide>
        ...
        <Slide>
          ...
          <AnimatedList>
            <ListItem>Focusing on the "divergent" phase of design.</ListItem>
            <ListItem>
            ...
            <DiscussionCard title="Group Discussion">
              Can LLMs truly be creative, or are they just recombining existing
              concepts?
            </DiscussionCard>
          </AnimatedList>
        </Slide>
        ...
        <Slide>
          ...
          <AnimatedList>
            ...
            <ListItem>
              Better at "small ideas" (incremental) than "big ideas" (paradigm
              shifts) <Citation ids={[2]} />.
            </ListItem>
            <ListItem>
        ...
        <Slide>
          ...
          <AnimatedList>
            ...
            <ListItem>
              Identifying "white space" opportunities through unstructured data
              analysis.
            </ListItem>
            <ListItem>
        ...
        <Slide>
          ...
          <AnimatedList>
            ...
            <ListItem>
              Constraining AI to "obey physics" for accurate predictions with
              sparse data <Citation ids={[17]} />.
            </ListItem>
            <ListItem>
              Enabling "real-time simulation" without waiting for FEA solvers{" "}
              <Citation ids={[18]} />.
            </ListItem>
            <DiscussionCard title="Group Discussion">
        ...
        <Slide>
          ...
          <AnimatedList>
            ...
            <ListItem>
              Autonomous configuration for <Highlight>"Lot Size 1"</Highlight>{" "}
              manufacturing <Citation ids={[37, 38]} />.
            </ListItem>
            <ListItem>
        ...
        <Slide>
          ...
          <AnimatedList>
            <ListItem>Closing the loop from usage telemetry to R&D.</ListItem>
            <ListItem>
        ...
        <Slide>
          ...
          <AnimatedList>
            <ListItem>Safety and ethics as paramount in physical AI.</ListItem>
            <ListItem>
        ...
        <Slide>
          ...
          <AnimatedList>
            ...
            <ListItem>Algorithmic fairness as a core quality metric.</ListItem>
            <DiscussionCard title="Group Discussion">
        ...
        <Slide>
          ...
          <AnimatedList>
            ...
            <ListItem>
              Automating documentation: model cards, risk assessments (Vanta,
              Monitaur) <Citation ids={[45, 46]} />.
            </ListItem>
            <ListItem>
